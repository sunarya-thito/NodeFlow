...
public class GreaterEqualsCompare extends AbstractNodeProvider {
    public GreaterEqualsCompare(NodeProviderCategory category) {
        super("java#greatercompare", "Is Greater Than Or Equals", category);
        ...
        return new CompileSession() {
            ...
            protected void handleCompile() {
                Java.If(getHandler().getReference((getNode().getParameter(0))))
                        .isGreaterOrEqualsTo(getHandler().getReference(getNode().getParameter(1))).Then(() -> {
                    ...
                    handler.putReference(node.getParameter(2), new Reference(boolean.class) {
                        ...
                        protected void write() {
                            Java.If(handler.getReference((node.getParameter(0))))
                                    .isGreaterOrEqualsTo(handler.getReference(node.getParameter(1))).Then(() -> {
