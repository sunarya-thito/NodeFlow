...
public class GreaterCompare extends AbstractNodeProvider {
    public GreaterCompare(NodeProviderCategory category) {
        super("java#greaterthancompare", "Is Greater Than", category);
        ...
        return new CompileSession() {
            ...
            protected void handleCompile() {
                Java.If(getHandler().getReference((getNode().getParameter(0))))
                        .isGreaterThan(getHandler().getReference(getNode().getParameter(1))).Then(() -> {
                    ...
                    handler.putReference(node.getParameter(2), new Reference(boolean.class) {
                        ...
                        protected void write() {
                            Java.If(handler.getReference((node.getParameter(0))))
                                    .isGreaterThan(handler.getReference(node.getParameter(1))).Then(() -> {
