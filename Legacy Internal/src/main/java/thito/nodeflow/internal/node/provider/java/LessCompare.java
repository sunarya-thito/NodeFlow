...
public class LessCompare extends AbstractNodeProvider {
    public LessCompare(NodeProviderCategory category) {
        super("java#lesscompare", "Is Less Than", category);
        ...
        return new CompileSession() {
            ...
            protected void handleCompile() {
                Java.If(getHandler().getReference((getNode().getParameter(0))))
                        .isLessThan(getHandler().getReference(getNode().getParameter(1))).Then(() -> {
                    ...
                    handler.putReference(node.getParameter(2), new Reference(boolean.class) {
                        ...
                        protected void write() {
                            Java.If(handler.getReference((node.getParameter(0))))
                                    .isLessThan(handler.getReference(node.getParameter(1))).Then(() -> {
