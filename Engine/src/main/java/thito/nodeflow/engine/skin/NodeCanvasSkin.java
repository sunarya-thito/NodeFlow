...
public class NodeCanvasSkin extends Skin {
    ...
    private StyleableObjectProperty<Color> thinLineColor =
            new SimpleStyleableObjectProperty<>(metaThinLineColor, Color.BLACK);
    private StyleableObjectProperty<Color> thickLineColor =
            new SimpleStyleableObjectProperty<>(metaThickLineColor, Color.BLACK);

    private Rectangle selectionPane = new Rectangle();
    private Pane selectionLayer = new Pane(selectionPane);
    ...
    private Pane linkingLayer = new Pane();
    private Pane linkTrailLayer = new Pane();
    private ObjectProperty<BoundingBox> selection = new SimpleObjectProperty<>();
    private ObservableList<NodeLinking> linkingList = FXCollections.observableArrayList();
